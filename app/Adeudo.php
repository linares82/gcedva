...
class Adeudo extends Model
{
	...
	//Mass Assignment
	protected $fillable = ['cliente_id','caja_concepto_id','cuenta_contable_id','cuenta_recargo_id','fecha_pago','monto','inicial_bnd','plan_pago_ln_id','usu_alta_id','usu_mod_id'];
