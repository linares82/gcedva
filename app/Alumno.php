...
class Alumno extends Model
{
    ...
    public function __construct(array $attributes = array())
    {
		...
		$this->addRelationApp( new \App\StCliente, 'name' );  // generated by relation command - StCliente,Alumno
	...
	//Mass Assignment
	protected $fillable = ['matricula','nombre','nombre2','ape_paterno','ape_materno','genero','curp','fec_nacimiento','lugar_nacimiento','extranjero','fec_inscripcion','tel_fijo','tel_cel','cel_empresa','mail','mail_empresa','calle','no_interior','no_exterior','colonia','cp','municipio_id','estado_id','st_cliente_id','distancia_escuela','peso','estatura','tipo_sangre','alergias','medicinas_contraindicadas','color_piel','color_cabello','senas_particulares','nombre_padre','curp_padre','dir_padre','tel_padre','cel_padre','tel_ofi_padre','mail_padre','nombre_madre','curp_madre','dir_madre','tel_madre','cel_madre','tel_ofi_madre','mail_madre','nombre_acudiente','curp_acudiente','dir_acudiente','tel_acudiente','cel_acudiente','tel_ofi_acudiente','mail_acudiente','plantel_id','especialidad_id','nivel_id','grado_id','cve_alumno','usu_alta_id','usu_mod_id'];
