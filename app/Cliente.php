...
class Cliente extends Model
{
	...
	protected $fillable = [
		...
		'fec_limite_entrega_docs',
		'fec_vencimiento_cred',
		'obs_docs',
		'bnd_reclasificado',
		'bnd_consulta_curp',
		'abreviatura_estado',
		'fec_docs_oblig_entregados',
		'fec_valida_curp'
	];
	...
	public function historiaClienteDuplicado()
	{
		return $this->hasOne('App\HistoriaCliente', 'cliente_duplicado_id', 'id');
	} // end
