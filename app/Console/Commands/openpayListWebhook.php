...
class openpayListWebhook extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'ian:openpayListWebhook {plantel}';
     ...
     * @var string
     */
    protected $description = 'Listar webhooks disponibles en openpay para un plantel';
