...
class openpayShowWebhook extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'ian:show {plantel} {webhook_id}';
     ...
     * @var string
     */
    protected $description = 'Muestra la informacion de un webhoo especifico identificado por su id en un plantel';
