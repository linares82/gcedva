...
class Empresa extends Model
{
	...
	//Mass Assignment
	protected $fillable = ['razon_social','nombre_contacto','tel_fijo','tel_cel','correo1','correo2','calle','no_int','no_ex','colonia','municipio_id','estado_id','cp','giro_id','plantel_id','especialidad_id','cuestionario_id','usu_alta_id','usu_mod_id'];
