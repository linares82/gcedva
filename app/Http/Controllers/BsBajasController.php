...
*/
	...
	public function bajasCreadasR(Request $request){
		$datos=$request->all();
		//dd($datos);
		$registros=BsBaja::select('p.razon','c.id','c.matricula','stc.name as estatus','bs_bajas.fecha_baja','bs_bajas.fecha_baja','bs_bajas.bnd_baja',
			'bs_bajas.fecha_reactivar','bs_bajas.bnd_reactivar')
