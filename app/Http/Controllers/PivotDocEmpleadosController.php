...
use Auth;
use App\Http\Requests\updatePivotDocEmpleado;
use App\Http\Requests\createPivotDocEmpleado;

class PivotDocEmpleadosController extends Controller {
	 ...
	 * @return Response
	 */
	public function destroy($id,PivotDocEmpleado $pivotDocEmpleado)
	{
		$pivotDocEmpleado=$pivotDocEmpleado->find($id);
		$empleado=$pivotDocEmpleado->empleado_id;
		$pivotDocEmpleado->delete();


		return redirect()->route('empleados.edit', $empleado)->with('message', 'Registro Borrado.');
	}
