...
class createCliente extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'especialidad_id' => 'required|integer|between:1,10000',
            'nivel_id' => 'required|integer|between:1,10000',
            'grado_id' => 'required|integer|between:1,10000',
            'medio_id' => 'required|integer|between:1,10000',
