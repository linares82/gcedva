...
class createEmpleado extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'evaluacion_psico_folio'=> 'max:1000',
            'plantel_id'=>'required',
    ...
    public function messages(){
        return [
            ...
            'foto_file.mimes'=> 'Formatos validos jpeg,jpg,png',
            'foto_file.max'=> 'Tamaño máximo 1000 kb',
            'identificacion.mimes'=> 'Formatos validos jpeg,jpg,png',
            'identificacion.max'=> 'Tamaño máximo 1000 kb',
            'contrato.max'=> 'Tamaño máximo 1000 kb',
            'evaluacion_psico'=> 'Tamaño máximo 1000 kb',
