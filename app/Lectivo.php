...
class Lectivo extends Model
{
	...
	//Mass Assignment
	protected $fillable = ['name', 'activo', 'bachillerato_bnd', 'carrera_bnd', 'usu_alta_id', 'usu_mod_id', 'inicio', 'fin', 'grafica_bnd', 'desc_certificado', 'ciclo_escolar', 'periodo_escolar', 'lectivo_anterior_id'];
	...
	public function calendarioExaExtras()
	{
		return $this->hasMany('App\CalendarioExaExtras');
	} // end
