...
class Materium extends Model
{
    ...
    public function __construct(array $attributes = array())
    {
		...
		//$this->addRelationApp( new \App\Materium, 'name' );  // generated by relation command - Plantel,Materium
    } 

	//Mass Assignment
	protected $fillable = ['name','abreviatura','seriada_bnd','serie_anterior','plantel_id','usu_alta_id','usu_mod_id'];
