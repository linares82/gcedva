...
class Prospecto extends Model
{
	...
	public function __construct(array $attributes = array())
	{
		...
		$this->addRelationApp(new \App\TipoEscuelaProcedencium, 'name');  // generated by relation command - Grado,Prospecto
		$this->addRelationApp(new \App\SepTEstudioAntecedente, 't_estudio_antecedente');  // generated by relation command - Grado,Prospecto
	}
	...
	{
		return $this->belongsTo('App\SepTEstudioAntecedente');
	} // end

	public function tipoEscuelaProcedencia()
	{
		return $this->belongsTo('App\TipoEscuelaProcedencium');
	} // end
