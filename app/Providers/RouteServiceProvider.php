...
class RouteServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
		...
		Route::model('stLeads', 'App\StLead');// generated by scaffold - StLead
		Route::model('leads', 'App\Lead');// generated by scaffold - Lead
		Route::model('tipoEscuelaProcedencias', 'App\TipoEscuelaProcedencium');// generated by scaffold - TipoEscuelaProcedencium
		Route::model('leadHEstatuses', 'App\LeadHEstatus');// generated by scaffold - LeadHEstatus
		Route::model('prospectoEtiquetas', 'App\ProspectoEtiquetum');// generated by scaffold - ProspectoEtiquetum
		Route::model('prospectoParteInformes', 'App\ProspectoParteInforme');// generated by scaffold - ProspectoParteInforme
		Route::model('prospectoInformes', 'App\ProspectoInforme');// generated by scaffold - ProspectoInforme
		Route::model('incidenciasJustificacions', 'App\IncidenciasJustificacion');// generated by scaffold - IncidenciasJustificacion
		Route::model('calendarioExaExtras', 'App\CalendarioExaExtra');// generated by scaffold - CalendarioExaExtra
		Route::model('calendarioAsignacionPonderacions', 'App\CalendarioAsignacionPonderacion');// generated by scaffold - CalendarioAsignacionPonderacion
		Route::model('calendarioIncidenciaCals', 'App\CalendarioIncidenciaCal');// generated by scaffold - CalendarioIncidenciaCal
		Route::model('materials', 'App\Material');// generated by scaffold - Material
		Route::model('materials', 'App\Material');// generated by scaffold - Material
		Route::model('materials', 'App\Material');// generated by scaffold - Material
    }
