...
class CreatePeticionOpenpaysTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('peticion_openpays', function (Blueprint $table) {
            ...
            $table->string('rpayment_method_bank')->nullable();
            $table->string('rpayment_method_agreement')->nullable();
            $table->string('rpayment_method_clabe')->nullable();
            ...
            $table->datetime('notificacion_pagado')->nullable();
