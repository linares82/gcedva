...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::open(['route' => 'adeudos.adeudosXConceptoAlMesR', 'id' => 'frm']) !!}

            <div class="form-group col-md-6 @if ($errors->has('fecha_f')) has-error @endif">
                <label for="fecha_f-field">A la fecha:</label>
                {!! Form::text('fecha_f', null, ['class' => 'form-control input-sm fecha', 'id' => 'fecha_f-field']) !!}
