...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::open(array('route' => 'adeudos.maestroEjecutivoR', 'id'=>'frm')) !!}

            <div class="form-group col-md-6 @if($errors->has('tipo_reporte')) has-error @endif">
                <label for="tipo_reporte">Tipo Reporte:</label>
                {!! Form::select("tipo_reporte", array(0=>"Seleccionar Opción", 1=>"Adeudos", 2=>"Pagos"), null, array("class" => "form-control select_seguridad", "id" => "tipo_reporte-field")) !!}
