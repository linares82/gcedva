    ...
    <div class="tab-content">
                ...
                <div class="box box-default box-solid">
                    ...
                    <div class="box-body">
                        <div class="form-group col-md-4 col-md-4 @if ($errors->has('plantel_id')) has-error @endif">
                            ...
                            {!! Form::hidden('puesto_id', 3, ['class' => 'form-control input-sm', 'id' => 'puesto_id-field']) !!}
                        ...
                        <div class="form-group col-md-4 @if ($errors->has('empleado_id')) has-error @endif">
                            ...
                            {!! Form::select('empleado_id', $list['Empleado'], null, [
                                'class' => 'form-control select_seguridad',
                                'id' => 'empleado_id-field',
                            ]) !!}
                        ...
                        @permission('asignacionAcademicas.docenteOficial')
                            <div class="form-group col-md-4 @if ($errors->has('docente_oficial')) has-error @endif">
                                ...
                                {!! Form::text('docente_oficial', null, ['class' => 'form-control input-sm', 'id' => 'docente_oficial-field']) !!}
                            ...
                            <div class="form-group col-md-4 @if ($errors->has('docente_oficial_id')) has-error @endif">
                                ...
                                {!! Form::select('docente_oficial_id', $list['Empleado'], null, [
                                    'class' => 'form-control select_seguridad',
                                    'id' => 'docente_oficial_id-field',
                                ]) !!}
                        ...
                        <div class="form-group col-md-4 @if ($errors->has('grupo_id')) has-error @endif">
                            ...
                            {!! Form::select('grupo_id', $list['Grupo'], null, [
                                'class' => 'form-control select_seguridad',
                                'id' => 'grupo_id-field',
                            ]) !!}
                        ...
                        <div class="form-group col-md-4 @if ($errors->has('materium_id')) has-error @endif">
                            ...
                            {!! Form::select(
                                ...
                                ['class' => 'form-control select_seguridad', 'id' => 'materium_id-field'],
                            ) !!}
                        ...
                        <div class="form-group col-md-4 @if ($errors->has('horas')) has-error @endif">
                            ...
                            {!! Form::text('horas', null, ['class' => 'form-control input-sm', 'id' => 'horas-field']) !!}
                            @if ($errors->has('horas'))
                        ...
                        <div class="form-group col-md-4 @if ($errors->has('lectivo_oficial_id')) has-error @endif">
                            ...
                            {!! Form::select('lectivo_oficial_id', $list['Lectivo'], null, [
                                'class' => 'form-control select_seguridad',
                                'id' => 'lectivo_oficial_id-field',
                            ]) !!}
                        ...
                        <div class="form-group col-md-4 @if ($errors->has('asistencias_max')) has-error @endif"
                            ...
                            {!! Form::text('asistencias_max', null, ['class' => 'form-control input-sm', 'id' => 'asistencias_max-field']) !!}
                        ...
                        <div class="form-group col-md-4 @if ($errors->has('fec_inicio')) has-error @endif">
                            ...
                            {!! Form::text('fec_inicio', null, ['class' => 'form-control input-sm', 'id' => 'fec_inicio-field']) !!}
                        ...
                        <div class="form-group col-md-4 @if ($errors->has('fec_fin')) has-error @endif">
                            ...
                            {!! Form::text('fec_fin', null, ['class' => 'form-control input-sm', 'id' => 'fec_fin-field']) !!}
                    ...
                    <div class="box-body">
                            ...
                            <div class="form-group col-md-12">
                                <div class="form-group col-md-4 @if ($errors->has('dia_id')) has-error @endif">
                                    ...
                                    {!! Form::select('dia_id', $list1['Dium'], null, [
                                        'class' => 'form-control select_seguridad',
                                        'id' => 'dia_id-field',
                                    ]) !!}
                                ...
                                <div class="form-group col-md-4 @if ($errors->has('duracion_clase')) has-error @endif">
                                    ...
                                    {!! Form::text('duracion_clase', null, ['class' => 'form-control input-sm', 'id' => 'duracion_clase-field']) !!}
                                        ...
                                        <tbody>
                                            @foreach ($asignacionAcademica->horarios as $h)
                                                <tr>
                                                    ...
                                                    <td><a href="{!! route('horarios.destroy', $h->id) !!}"
        ...
        <div id="tab2" class="tab-pane active">
            <div class="form-group col-md-4 @if($errors->has('carga_ponderacion_id')) has-error @endif">
                    ...
                    {!! Form::select("carga_ponderacion_id", [], null, array("class" => "form-control select_seguridad", "id" => "carga_ponderacion_id-field")) !!}
                    @if($errors->has("carga_ponderacion_id"))
                     <span class="help-block">{{ $errors->first("carga_ponderacion_id") }}</span>
                    @endif
                 </div>
            <div class="form-group col-md-4 @if ($errors->has('ce_fec_inicio')) has-error @endif">
                <label for="ce_fec_inicio-field">F. Inicio</label>
                {!! Form::text('ce_fec_inicio', null, ['class' => 'form-control calendario fecha', 'id' => 'ce_fec_inicio-field']) !!}
                @if ($errors->has('ce_fec_inicio'))
                    <span class="help-block">{{ $errors->first('ce_fec_inicio') }}</span>
                @endif
            </div>
            <div class="form-group col-md-4 @if ($errors->has('ce_fec_fin')) has-error @endif">
                <label for="ce_fec_fin-field">F. fin</label>
                {!! Form::text('ce_fec_fin', null, ['class' => 'form-control fecha', 'id' => 'ce_fec_fin-field']) !!}
                @if ($errors->has('ce_fec_fin'))
                    <span class="help-block">{{ $errors->first('ce_fec_fin') }}</span>
                @endif
            </div>
        </div>
        <div class="col-md-12">
            <table class="table table-condensed table-striped">
                ...
                <tbody>
                    @foreach ($calendarioAsignacionPonderacions as $calendario)
                        <tr>
                            <td>{{ $calendario->cargaPonderacion->name }}</td>
                            <td>{{ $calendario->fec_inicio }}</td>
                            <td>{{ $calendario->fec_fin }}</td>
                            <td><a href="{!! route('calendarioAsignacionPonderacions.destroy', $calendario->id) !!}"
                                    class="btn btn-xs btn-danger">Eliminar</a></td>
                        </tr>
                    @endforeach
                </tbody>
                ...
                function getCmbInstructores() {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $('#empleado_id-field').append($('<option></option>').text('Seleccionar Opción')
                                .val('0'));

                            $.each(data, function(i) {
                                //alert(data[i].name);
                                $('#empleado_id-field').append("<option " + data[i].selectec +
                                    " value=\"" + data[i].id + "\">" + data[i].nombre +
                                    "<\/option>");
                ...
                function getCmbMaterias() {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            //$('#especialidad_id-field').empty();
                            $('#materium_id-field').append($('<option></option>').text('Seleccionar').val(
                                '0'));

                            $.each(data, function(i) {
                                //alert(data[i].name);
                                $('#materium_id-field').append("<option " + data[i].selectec +
                ...
                function getCmbGrupos() {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            //$('#especialidad_id-field').empty();
                            $('#grupo_id-field').append($('<option></option>').text('Seleccionar').val(
                            '0'));

                            $.each(data, function(i) {
                                //alert(data[i].name);
                                $('#grupo_id-field').append("<option " + data[i].selectec +
                                    " value=\"" + data[i].id + "\">" + data[i].name +
                                    "<\/option>");
            ...
            function cmbPonderaciones(){
                $.ajax({
                    url: '{{ route("hacademicas.cmbPonderaciones") }}',
                            type: 'GET',
                            data: "tpo_examen_id=1" + 
                                "&asignacion_id=" + {{$asignacionAcademica->id}} + 
