...
/* 
    ...
    <body>
        <div id="printeArea">
            ...
            <tr ><td colspan='2' align="center" class="td_centro">ACTA DE CALIFICACIÓN VIA ORDINARIO {{ (!is_null($nomenclatura[$numero])) ? $nomenclatura[$numero]." DEFINITIVA" : "" }} </td></tr>
            </table>
            <br/>
            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        <td>Programa</td><td colspan='3'>{{ $encabezado->grado->name }}</td>
                    </tr>
                    <tr>
