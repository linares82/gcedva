...
<ol class="breadcrumb">
    ...
    <li class="active">Calendario por asignacion y ponderacion</li>
</ol>

<div class="page-header">
    <h3><i class="glyphicon glyphicon-plus"></i> @yield('asignacionAcademicasAppTitle') / Calendario por asignacion y ponderacion </h3>
</div>
@endsection
...
<div class="row">
    <div class="col-md-12">
        ...
        {!! Form::open(['route' => 'asignacionAcademica.asignacionCalendarioPonderacionR', 'id' => 'frm_seguimiento']) !!}
        ...
        <div class="form-group col-md-6 @if ($errors->has('lectivo_f')) has-error @endif">
            ...
            {!! Form::select('lectivo_f', $lectivos, null, [
            'class' => 'form-control select_seguridad',
            'id' => 'lectivo_f-field',
            ]) !!}
