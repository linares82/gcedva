                <div class="form-group @if($errors->has('cliente_id')) has-error @endif">
                    ...
                    <div class="form-group @if($errors->has('fecha_reactivar')) has-error @endif">
                       <label for="fecha_reactivar-field">Fecha_reactivar</label>
                       {!! Form::text("fecha_reactivar", null, array("class" => "form-control", "id" => "fecha_reactivar-field")) !!}
                       @if($errors->has("fecha_reactivar"))
                        <span class="help-block">{{ $errors->first("fecha_reactivar") }}</span>
                       @endif
                    </div>
                    <div class="form-group @if($errors->has('bnd_reactivar')) has-error @endif">
                       <label for="bnd_reactivar-field">Bnd_reactivar</label>
                       {!! Form::text("bnd_reactivar", null, array("class" => "form-control", "id" => "bnd_reactivar-field")) !!}
                       @if($errors->has("bnd_reactivar"))
                        <span class="help-block">{{ $errors->first("bnd_reactivar") }}</span>
                       @endif
                    </div>
