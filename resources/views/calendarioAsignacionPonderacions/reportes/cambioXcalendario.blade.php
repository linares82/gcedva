...
@section('header')
    <ol class="breadcrumb">
        ...
        <li class="active">Calificaciones editadas dentro de Calednario de asignacio</li>
    </ol>

    <div class="page-header">
        <h3><i class="glyphicon glyphicon-plus"></i> @yield('seguimientosAppTitle') / Calificaciones editadas dentro de Calednario de asignacio </h3>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::open(['route' => 'calendarioAsignacionPonderacions.cambioXcalendarioR']) !!}
