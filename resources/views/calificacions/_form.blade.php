                <div class="form-group @if($errors->has('hacademica_id')) has-error @endif">
                       ...
                       {!! Form::text("hacademica_id", null, array("class" => "form-control input-sm", "id" => "hacademica_id-field")) !!}
                    ...
                    <div class="form-group @if($errors->has('examen_id')) has-error @endif">
                       ...
                       {!! Form::text("examen_id", null, array("class" => "form-control input-sm", "id" => "examen_id-field")) !!}
                    ...
                    <div class="form-group @if($errors->has('reporte_bnd')) has-error @endif">
                       ...
                       {!! Form::text("reporte_bnd", null, array("class" => "form-control input-sm", "id" => "reporte_bnd-field")) !!}
