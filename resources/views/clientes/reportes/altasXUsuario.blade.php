...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::open(array('route' => 'clientes.reportes.altasXUsuarioR', 'id'=>'frm_reporte')) !!}
                ...
                <div class="form-group col-md-6 @if($errors->has('usuario_f')) has-error @endif">
                    <label for="usuario_f-field">Usuario de:</label>
                    {!! Form::select("usuario_f", $list["User"], null, array("class" => "form-control select_seguridad", "id" => "usuario_f-field")) !!}
                    @if($errors->has("usuario_f"))
                    <span class="help-block">{{ $errors->first("usuario_f") }}</span>
                    @endif
                </div>
            
                <div class="form-group col-md-6 @if($errors->has('usuario_t')) has-error @endif">
                    <label for="usuario_t-field">Usuario a:</label>
                    {!! Form::select("usuario_t", $list["User"], null, array("class" => "form-control select_seguridad", "id" => "usuario_t-field")) !!}
                    @if($errors->has("usuario_t"))
                    <span class="help-block">{{ $errors->first("usuario_t") }}</span>
                    @endif
                </div>
