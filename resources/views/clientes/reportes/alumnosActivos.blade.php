...
@section('header')
	...
	<ol class="breadcrumb">
	    ...
	    <li class="active">Alumnos Activos</li>
	</ol>

    <div class="page-header">
        <h3><i class="glyphicon glyphicon-plus"></i> @yield('seguimientosAppTitle') / Alumnos Activos </h3>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::open(array('route' => 'clientes.clientesActivosR', 'id'=>'frm_reporte')) !!}

                <div class="form-group col-md-6 @if($errors->has('fecha_f')) has-error @endif">
                    <label for="fecha_f-field">Fecha:</label>
