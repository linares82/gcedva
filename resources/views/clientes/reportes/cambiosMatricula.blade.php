...
@section('header')
	...
	<ol class="breadcrumb">
	    ...
	    <li class="active">Cambios Matricula</li>
	</ol>

    <div class="page-header">
        <h3><i class="glyphicon glyphicon-plus"></i> @yield('seguimientosAppTitle') / Camios Matricula </h3>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::open(array('route' => 'clientes.cambiosMatriculaR', 'id'=>'frm_reporte')) !!}
