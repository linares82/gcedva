                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                <label for="q_clientes.st_cliente_id_cont">ESTATUS</label>
                                    ...
                                    {!! Form::select("st_cliente_id", $list1["StCliente"], "{{ @(Request::input('q')['clientes.st_cliente_id_cont']) ?: '' }}", array("class" => "form-control input-sm", "name"=>"q[clientes.st_cliente_id_cont]", "id"=>"q_clientes.st_cliente_id_cont", "style"=>"width:100%;" )) !!}
