                <div class="form-group @if($errors->has('cliente_id')) has-error @endif">
                    ...
                    <div class="form-group @if($errors->has('especialidad_id')) has-error @endif">
                       ...
                       {!! Form::text("especialidad_id", null, array("class" => "form-control input-sm", "id" => "especialidad_id-field")) !!}
                    ...
                    <div class="form-group @if($errors->has('nivel_id')) has-error @endif">
                       ...
                       {!! Form::text("nivel_id", null, array("class" => "form-control input-sm", "id" => "nivel_id-field")) !!}
                    ...
                    <div class="form-group @if($errors->has('grado_id')) has-error @endif">
                       ...
                       {!! Form::text("grado_id", null, array("class" => "form-control input-sm", "id" => "grado_id-field")) !!}
                    ...
                    <div class="form-group @if($errors->has('turno_id')) has-error @endif">
                       ...
                       {!! Form::text("turno_id", null, array("class" => "form-control input-sm", "id" => "turno_id-field")) !!}
                    ...
                    <div class="form-group @if($errors->has('bnd_inscrito')) has-error @endif">
                       ...
                       {!! Form::text("bnd_inscrito", null, array("class" => "form-control input-sm", "id" => "bnd_inscrito-field")) !!}
                    ...
                    <div class="form-group @if($errors->has('fec_inscrito')) has-error @endif">
                       ...
                       {!! Form::text("fec_inscrito", null, array("class" => "form-control input-sm", "id" => "fec_inscrito-field")) !!}
