                <div class="form-group @if($errors->has('empresa_id')) has-error @endif">
                       ...
                       {!! Form::text("empresa_id", null, array("class" => "form-control input-sm", "id" => "empresa_id-field")) !!}
                    ...
                    <div class="form-group @if($errors->has('plantel_id')) has-error @endif">
                       ...
                       {!! Form::text("plantel_id", null, array("class" => "form-control input-sm", "id" => "plantel_id-field")) !!}
