                ...
                <table class="table table-condensed table-striped">
                    <thead>
                        <tr>
                            ...
                            <th>@include('CrudDscaffold::getOrderlink', ['column' => 'muebles.id', 'title' => 'MUEBLE_ID'])</th>
                        <th>@include('CrudDscaffold::getOrderlink', ['column' => 'st_muebles.id', 'title' => 'ST_MUEBLE_NAME'])</th>
