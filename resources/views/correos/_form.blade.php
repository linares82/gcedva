                <div class="form-group col-md-4 @if($errors->has('usu_envio_id')) has-error @endif">
                       ...
                       {!! Form::text("usu_envio_id", null, array("class" => "form-control input-sm", "id" => "usu_envio_id-field")) !!}
                    ...
                    <div class="form-group col-md-4 @if($errors->has('fecha_envio')) has-error @endif">
                       ...
                       {!! Form::text("fecha_envio", null, array("class" => "form-control input-sm", "id" => "fecha_envio-field")) !!}
