                ...
                <table class="table table-condensed table-striped">
                    <thead>
                        <tr>
                            ...
                            <th>@include('CrudDscaffold::getOrderlink', ['column' => 'cotizacion_cursos.no_coti', 'title' => 'COTIZACION_CURSO_NO_COTI'])</th>
                        <th>@include('CrudDscaffold::getOrderlink', ['column' => 'consecutivo', 'title' => 'CONSECUTIVO'])</th>
                        <th>@include('CrudDscaffold::getOrderlink', ['column' => 'cursos_empresas.name', 'title' => 'CURSOS_EMPRESA_NAME'])</th>
                        <th>@include('CrudDscaffold::getOrderlink', ['column' => 'tipo_precio_cotis.name', 'title' => 'TIPO_PRECIO_COTI_NAME'])</th>
                        <th>@include('CrudDscaffold::getOrderlink', ['column' => 'cantidad', 'title' => 'CANTIDAD'])</th>
                        <th>@include('CrudDscaffold::getOrderlink', ['column' => 'precio', 'title' => 'PRECIO'])</th>
