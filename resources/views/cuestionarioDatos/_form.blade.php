                <div class="form-group @if($errors->has('cuestionario_id')) has-error @endif">
                       ...
                       {!! Form::text("cuestionario_id", null, array("class" => "form-control", "id" => "cuestionario_id-field")) !!}
                    ...
                    <div class="form-group @if($errors->has('cuestionario_pregunta')) has-error @endif">
                       ...
                       {!! Form::text("cuestionario_pregunta", null, array("class" => "form-control", "id" => "cuestionario_pregunta-field")) !!}
                    ...
                    <div class="form-group @if($errors->has('cuestionario_respuesta_id')) has-error @endif">
                       ...
                       {!! Form::text("cuestionario_respuesta_id", null, array("class" => "form-control", "id" => "cuestionario_respuesta_id-field")) !!}
