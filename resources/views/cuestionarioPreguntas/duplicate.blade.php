...
@section('header')
    ...
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-duplicate"></i> @yield('cuestionarioPreguntasAppTitle') / Duplicar {{$cuestionarioPregunta->id}}</h1>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::model($cuestionarioPregunta, array('route' => array('cuestionarioPreguntas.store'))) !!}
