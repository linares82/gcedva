...
@section('header')
	...
	<ol class="breadcrumb">
	    ...
	    <li><a href="{{ route('cursos.show', $curso->id) }}">{{ $curso->id }}</a></li>
	    <li class="active">Editar</li>
	</ol>

    <div class="page-header">
        <h3><i class="glyphicon glyphicon-edit"></i> @yield('cursosAppTitle') / Editar {{$curso->id}}</h3>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::model($curso, array('route' => array('cursos.update', $curso->id),'method' => 'post')) !!}
