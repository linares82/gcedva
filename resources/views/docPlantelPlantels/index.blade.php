                ...
                <table class="table table-condensed table-striped">
                    <thead>
                        <tr>
                            ...
                            <th>@include('CrudDscaffold::getOrderlink', ['column' => 'doc_plantels.razon', 'title' => 'DOC_PLANTEL_RAZON'])</th>
                        <th>@include('CrudDscaffold::getOrderlink', ['column' => 'plantels.razon', 'title' => 'PLANTEL_RAZON'])</th>
                        <th>@include('CrudDscaffold::getOrderlink', ['column' => 'fec_vigencia', 'title' => 'FEC_VIGENCIA'])</th>
