        ...
        <div class="col-md-12">
            @if($duracionPeriodos->count())
                <table class="table table-condensed table-striped">
                    ...
                    <td>{{$duracionPeriodo->usu_alta_id}}</td>
                    <td>{{$duracionPeriodo->usu_mod_id}}</td>
                                <td class="text-right">
                                    @permission('duracionPeriodos.edit')
                                    <a class="btn btn-xs btn-primary" href="{{ route('duracionPeriodos.duplicate', $duracionPeriodo->id) }}"><i class="glyphicon glyphicon-duplicate"></i> Duplicate</a>
                                    @endpermission
                                    @permission('duracionPeriodos.edit')
