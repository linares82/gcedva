                ...
                <table class="table table-condensed table-striped">
                    <thead>
                        <tr>
                            ...
                            <th>@include('CrudDscaffold::getOrderlink', ['column' => 'plantels.plantel', 'title' => 'PLANTEL'])</th>
                            <th>@include('CrudDscaffold::getOrderlink', ['column' => 'fecha', 'title' => 'FECHA'])</th>
                        <th>@include('CrudDscaffold::getOrderlink', ['column' => 'egresos_conceptos.name', 'title' => 'EGRESOS CONCEPTO'])</th>
                        <th>@include('CrudDscaffold::getOrderlink', ['column' => 'forma_pagos.name', 'title' => 'FORMA PAGO'])</th>
                        <th>@include('CrudDscaffold::getOrderlink', ['column' => 'cuentas_efectivos.name', 'title' => 'CUENTA EFECTIVO'])</th>
                        <th>@include('CrudDscaffold::getOrderlink', ['column' => 'monto', 'title' => 'MONTO'])</th>
                        <th>@include('CrudDscaffold::getOrderlink', ['column' => 'empleado.nombre', 'title' => 'RESPONSABLE'])</th>
                        <th>COMPROBANTE</th>
