...
@section('header')
    ...
    <ol class="breadcrumb">
        ...
        @if ( $query_params = Request::input('q') )
            ...
            <li class="active"><a href="{{ route('egresosConceptos.index') }}">@yield('egresosConceptosAppTitle')</a></li>
        ...
        @else
            <li class="active">@yield('egresosConceptosAppTitle')</li>
        @endif
        -->
        <li class="active">@yield('egresosConceptosAppTitle')</li>
    </ol>
    ...
    <div class="">
        <h3>
            <i class="glyphicon glyphicon-align-justify"></i> @yield('egresosConceptosAppTitle')
            @permission('egresosConceptos.create')
            <a class="btn btn-success pull-right" href="{{ route('egresosConceptos.create') }}"><i class="glyphicon glyphicon-plus"></i> Crear</a>
            @endpermission
        </h3>
        ...
        <div class="panel panel-default">
            ...
            <div aria-labelledby="headingOne" role="tabpanel" class="panel-collapse collapse" id="collapseOne">
                <div class="panel-body">
                    <form class="EgresosConcepto_search" id="search" action="{{ route('egresosConceptos.index') }}" accept-charset="UTF-8" method="get">
    ...
    <div class="row">
        <div class="col-md-12">
            @if($egresosConceptos->count())
                        ...
                        @foreach($egresosConceptos as $egresosConcepto)
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    @endpermission
                                    @permission('egresosConceptos.edit')
                                    <a class="btn btn-xs btn-warning" href="{{ route('egresosConceptos.edit', $egresosConcepto->id) }}"><i class="glyphicon glyphicon-edit"></i> Editar</a>
                                    @endpermission
                                    @permission('egresosConceptos.destroy')
                                    {!! Form::model($egresosConcepto, array('route' => array('egresosConceptos.destroy', $egresosConcepto->id),'method' => 'delete', 'style' => 'display: inline;', 'onsubmit'=> "if(confirm('¿Borrar? ¿Esta seguro?')) { return true } else {return false };")) !!}
                ...
                {!! $egresosConceptos->appends(Request::except('page'))->render() !!}
            @else
