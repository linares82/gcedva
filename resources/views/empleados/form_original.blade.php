                    <div class="box box-default">
                      ...
                      <div class="form-group col-md-4 @if($errors->has('puesto_id')) has-error @endif">
                         ...
                         {!! Form::select("puesto_id", $list["Puesto"], null, array("class" => "form-control input-sm", "id" => "puesto_id-field")) !!}
                      ...
                      <div class="form-group col-md-4 @if($errors->has('area_id')) has-error @endif">
                         ...
                         {!! Form::select("area_id", $list["Area"], null, array("class" => "form-control input-sm", "id" => "area_id-field")) !!}
                    ...
                    <div class="box box-default">
                      ...
                      <div class="form-group col-md-4 @if($errors->has('plantel_id')) has-error @endif">
                         ...
                         {!! Form::select("plantel_id", $list["Plantel"], null, array("class" => "form-control input-sm", "id" => "plantel_id-field")) !!}
                      ...
                      <div class="form-group col-md-4 @if($errors->has('user_id')) has-error @endif">
                          ...
                          {!! Form::select("user_id", $list["User"], null, array("class" => "form-control input-sm", "id" => "user_id-field")) !!}
                    ...
                    <div class="box box-default">
                      ...
                      <div class="form-group col-md-6 @if($errors->has('foto')) has-error @endif">
                         ...
                         {!! Form::text("foto", null, array("class" => "form-control input-sm", "id" => "foto-field", 'readonly'=>'readonly')) !!}
                         {!! Form::file('foto_file') !!}
                         @if (isset($empleado))
                      ...
                      <div class="form-group col-md-6 @if($errors->has('identificacion')) has-error @endif">
                         ...
                         {!! Form::text("identificacion", null, array("class" => "form-control input-sm", "id" => "identificacion-field", 'readonly'=>'readonly')) !!}
                    ...
                    <div class="box box-default">
                      ...
                      <div class="form-group col-md-6 @if($errors->has('contrato')) has-error @endif">
                         ...
                         {!! Form::text("contrato", null, array("class" => "form-control input-sm", "id" => "contrato-field", 'readonly'=>'readonly')) !!}
                      ...
                      <div class="form-group col-md-6 @if($errors->has('evaluacion_psico')) has-error @endif">
                         ...
                         {!! Form::text("evaluacion_psico", null, array("class" => "form-control input-sm", "id" => "evaluacion_psico-field", 'readonly'=>'readonly')) !!}
