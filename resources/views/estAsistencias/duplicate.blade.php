...
@section('header')
    ...
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-duplicate"></i> @yield('estAsistenciasAppTitle') / Duplicar {{$estAsistencium->id}}</h1>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::model($estAsistencium, array('route' => array('estAsistencias.store'))) !!}
