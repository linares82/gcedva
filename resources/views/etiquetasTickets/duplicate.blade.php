...
@section('header')
    ...
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-duplicate"></i> @yield('etiquetasTicketsAppTitle') / Duplicar {{$etiquetasTicket->id}}</h1>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::model($etiquetasTicket, array('route' => array('etiquetasTickets.store'))) !!}
