                ...
                <div class="form-group col-md-4 @if($errors->has('fecha')) has-error @endif">
                   ...
                   {!! Form::text("fecha", isset($facturaG->fecha) ? $facturaG->fecha : date('Y-m-d H:i:s'), array("class" => "form-control", "id" => "fecha-field")) !!}
                   @if($errors->has("fecha"))
                   ...
                   $(document).ready(function() {
                      ...
                      function getPlantel() {
                         $.ajax({
                            ...
                            type: 'GET',
                            data: 'cuenta=' + $('#cuentas_efectivo_id-field option:selected').val(),
                            dataType: 'json',
                            beforeSend: function() {
                               $("#loading").show();
                            },
