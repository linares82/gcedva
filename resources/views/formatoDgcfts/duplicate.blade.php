...
@section('header')
	...
	<ol class="breadcrumb">
	    ...
	    <li><a href="{{ route('formatoDgcfts.index') }}">@yield('formatoDgcftsAppTitle')</a></li>
	    <li class="active">Duplicate</li>
	</ol>

    <div class="page-header">
        <h1><i class="glyphicon glyphicon-duplicate"></i> @yield('formatoDgcftsAppTitle') / Duplicar {{$formatoDgcft->id}}</h1>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::model($formatoDgcft, array('route' => array('formatoDgcfts.store'))) !!}
