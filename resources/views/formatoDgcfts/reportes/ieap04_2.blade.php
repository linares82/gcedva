            ...
            <table width="100%">
                ...
                <tbody>
                    ...
                    @foreach ($materias as $materia)
                        <tr>
                            <td>{{$materia->grado}}</td><td>{{$formatoDgcft->grupo}}</td><td>{{$materia->sep_materia}}</td>
                            <td>{{$formatoDgcft->fec_inicio}}</td><td>{{$formatoDgcft->fec_fin}}</td>
                            <td>{{$formatoDgcft->horario_inicio}}</td><td>{{$formatoDgcft->horario_fin}}</td>
                            <td>{{$materia->duracion_horas}}</td><td>{{$formatoDgcft->formatoDgcftDetalles->where('bnd_satisfactorio',1)->count()}}</td>
