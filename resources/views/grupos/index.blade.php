                ...
                <div class="panel-body">
                    <form class="Grupo_search" id="search" action="{{ route('grupos.index') }}" accept-charset="UTF-8" method="get">
                        ...
                        <div class="form-horizontal">
                            ...
                            -->
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="q_limite_alumnos_cont">LIMITE_ALUMNOS</label>
                                <div class=" col-sm-9">
                                    <input class="form-control input-sm" type="search" value="{{ @(Request::input('q')['limite_alumnos_cont']) ?: '' }}" name="q[limite_alumnos_cont]" id="q_limite_alumnos_cont" />
                                                    ...
                                                    <!--
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="q_jornada_id_gt">JORNADA_ID</label>
                                <div class=" col-sm-4">
                                    <input class="form-control input-sm" type="search" value="{{ @(Request::input('q')['jornada_id_gt']) ?: '' }}" name="q[jornada_id_gt]" id="q_jornada_id_gt" />
                                </div>
                                <div class=" col-sm-1 text-center"> - </div>
                                <div class=" col-sm-4">
                                    <input class="form-control input-sm" type="search" value="{{ @(Request::input('q')['jornada_id_lt']) ?: '' }}" name="q[jornada_id_lt]" id="q_jornada_id_lt" />
                                </div>
                            </div>
                            -->
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="q_jornada_id_cont">JORNADA_ID</label>
                                <div class=" col-sm-9">
                                    <input class="form-control input-sm" type="search" value="{{ @(Request::input('q')['jornada_id_cont']) ?: '' }}" name="q[jornada_id_cont]" id="q_jornada_id_cont" />
                                </div>
                            </div>
                                                    <!--
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="q_salon_id_gt">SALON_ID</label>
                                <div class=" col-sm-4">
                                    <input class="form-control input-sm" type="search" value="{{ @(Request::input('q')['salon_id_gt']) ?: '' }}" name="q[salon_id_gt]" id="q_salon_id_gt" />
                                </div>
                                <div class=" col-sm-1 text-center"> - </div>
                                <div class=" col-sm-4">
                                    <input class="form-control input-sm" type="search" value="{{ @(Request::input('q')['salon_id_lt']) ?: '' }}" name="q[salon_id_lt]" id="q_salon_id_lt" />
                                </div>
                            </div>
                            -->
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="q_salon_id_cont">SALON_ID</label>
                                <div class=" col-sm-9">
                                    <input class="form-control input-sm" type="search" value="{{ @(Request::input('q')['salon_id_cont']) ?: '' }}" name="q[salon_id_cont]" id="q_salon_id_cont" />
                                </div>
                            </div>
                                                    <!--
                            <div class="form-group">
            ...
            @if($grupos->count())
                <table class="table table-condensed table-striped">
                    <thead>
                        ...
                        <th>@include('CrudDscaffold::getOrderlink', ['column' => 'desc_corta', 'title' => 'DESC_CORTA'])</th>
                        <th>@include('CrudDscaffold::getOrderlink', ['column' => 'limite_alumnos', 'title' => 'LIMITE_ALUMNOS'])</th>
                        <th>@include('CrudDscaffold::getOrderlink', ['column' => 'jornada_id', 'title' => 'JORNADA_ID'])</th>
                        <th>@include('CrudDscaffold::getOrderlink', ['column' => 'salon_id', 'title' => 'SALON_ID'])</th>
                        <th>@include('CrudDscaffold::getOrderlink', ['column' => 'periodo_id', 'title' => 'PERIODO_ID'])</th>
                    ...
                    <tbody>
                        @foreach($grupos as $grupo)
                            <tr>
                                ...
                                <td>{{$grupo->name}}</td>
                    <td>{{$grupo->desc_corta}}</td>
                    <td>{{$grupo->limite_alumnos}}</td>
                    <td>{{$grupo->jornada_id}}</td>
                    <td>{{$grupo->salon_id}}</td>
                    <td>{{$grupo->periodo_id}}</td>
                    <td>{{$grupo->usu_alta_id}}</td>
                    <td>{{$grupo->usu_mod_id}}</td>
                                <td class="text-right">
