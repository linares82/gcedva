                <div class="form-group @if($errors->has('prospecto_id')) has-error @endif">
                    ...
                    <div class="form-group @if($errors->has('alta_id')) has-error @endif">
                       <label for="alta_id-field">Alta_id</label>
                       {!! Form::text("alta_id", null, array("class" => "form-control", "id" => "alta_id-field")) !!}
                       @if($errors->has("alta_id"))
                        <span class="help-block">{{ $errors->first("alta_id") }}</span>
                       @endif
                    </div>
