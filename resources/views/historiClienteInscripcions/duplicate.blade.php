...
@section('header')
    ...
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-duplicate"></i> @yield('historiClienteInscripcionsAppTitle') / Duplicar {{$historiClienteInscripcion->id}}</h1>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::model($historiClienteInscripcion, array('route' => array('historiClienteInscripcions.store'))) !!}
