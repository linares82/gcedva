...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            @php
                $agrupamientoPlantels = App\PlantelAgrupamiento::pluck('name', 'id');
                $agrupamientoPlantels->prepend('Seleccionar Opcion', 0);
            @endphp

            {!! Form::open(['route' => 'historiaClientes.bajasSegementadoR', 'id' => 'frm_seguimiento']) !!}
            ...
            <div class="form-group col-md-6 @if ($errors->has('plantel_f')) has-error @endif">
                ...
                {!! Form::select('plantel_f[]', $plantels, null, [
                    'class' => 'form-control select_seguridad',
                    'id' => 'plantel_f-field',
                    'multiple' => true,
                ]) !!}
    ...
    <script type="text/javascript">
        ...
        function getCmbLectivos() {
            ...
            $.ajax({
                ...
                type: 'GET',
                data: "plantel_id=" + $('#plantel_f-field option:selected').val() + "&lectivo_id=" + $(
                    '#lectivo_f-field option:selected').val() + "",
                dataType: 'json',
                beforeSend: function() {
                ...
                success: function(data) {
                    ...
                    $.each(data, function(i) {
                        //alert(data[i].name);
                        $('#lectivo_f-field').append("<option " + data[i].selectec + " value=\"" + data[
        ...
        function getCmbGrupos() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data, function(i) {
                        //alert(data[i].name);
                        $('#grupo_f-field').append("<option " + data[i].selectec + " value=\"" + data[i]
        ...
        function getCmbMaterias() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data, function(i) {
                        //alert(data[i].name);
                        $('#materia_f-field').append("<option " + data[i].selectec + " value=\"" + data[
                            i].id + "\">" + data[i].name + "<\/option>");
                    });
                    //$example.select2();
                }
        ...
        function getCmbPonderaciones() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data, function(i) {
                        //alert(data[i].name);
                        $('#ponderacion_f-field').append("<option " + data[i].selectec + " value=\"" +
