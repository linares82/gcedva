                <div class="form-group @if($errors->has('asignacion_academica_id')) has-error @endif">
                       ...
                       {!! Form::text("asignacion_academica_id", null, array("class" => "form-control input-sm", "id" => "asignacion_academica_id-field")) !!}
                    ...
                    <div class="form-group @if($errors->has('dia_id')) has-error @endif">
                       ...
                       {!! Form::text("dia_id", null, array("class" => "form-control input-sm", "id" => "dia_id-field")) !!}
                    ...
                    <div class="form-group @if($errors->has('hora')) has-error @endif">
                       ...
                       {!! Form::text("hora", null, array("class" => "form-control input-sm", "id" => "hora-field")) !!}
                       @if($errors->has("hora"))
                    ...
                    <div class="form-group @if($errors->has('lectivo_id')) has-error @endif">
                       ...
                       {!! Form::select("lectivo_id", $list["Lectivo"], null, array("class" => "form-control input-sm", "id" => "lectivo_id-field")) !!}
