                <div class="form-group @if($errors->has('seguimiento_id')) has-error @endif">
                       ...
                       {!! Form::text("seguimiento_id", null, array("class" => "form-control input-sm", "id" => "seguimiento_id-field")) !!}
                    ...
                    <div class="form-group @if($errors->has('st_seguimiento_id')) has-error @endif">
                       ...
                       {!! Form::text("st_seguimiento_id", null, array("class" => "form-control input-sm", "id" => "st_seguimiento_id-field")) !!}
                    ...
                    <div class="form-group @if($errors->has('mes')) has-error @endif">
                       ...
                       {!! Form::text("mes", null, array("class" => "form-control input-sm", "id" => "mes-field")) !!}
                       @if($errors->has("mes"))
