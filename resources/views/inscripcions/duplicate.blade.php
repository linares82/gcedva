...
@section('header')
    ...
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-duplicate"></i> @yield('inscripcionsAppTitle') / Duplicar {{$inscripcion->id}}</h1>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::model($inscripcion, array('route' => array('inscripcions.store'))) !!}
