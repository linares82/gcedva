...
@section('header')
    ...
    <div class="page-header">
        <h3><i class="glyphicon glyphicon-plus"></i> @yield('asignacionAcademicasAppTitle') / Grupo Asignatura </h3>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::open(array('route' => 'inscripcions.evaluacionOER', 'id'=>'frm_seguimiento')) !!}
                ...
                <div class="form-group col-md-6 @if($errors->has('tipo_examen_f')) has-error @endif">
                    <label for="tipo_examen_f-field">Tipo Examen:</label>
                    {!! Form::select("tipo_examen_f", $tipoEvaluacion, null, array("class" => "form-control select_seguridad", "id" => "tipo_examen_f-field")) !!}
                    @if($errors->has("tipo_examen_f"))
                    <span class="help-block">{{ $errors->first("tipo_examen_f") }}</span>
                    @endif
                </div>
                <!--
