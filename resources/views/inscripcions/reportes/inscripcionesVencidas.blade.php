...
<div class="page-header">
    <h3><i class="glyphicon glyphicon-plus"></i> @yield('seguimientosAppTitle') / InscripcionesVencidas </h3>
</div>
@endsection
...
<div class="row">
    <div class="col-md-12">
        ...
        {!! Form::open(array('route' => 'inscripcions.inscripcionesVencidasR', 'id'=>'frm_analitica')) !!}
