...
/* 
    ...
    <body>
        ...
        <div id="printeArea" class='SaltoDePagina'>
            <h3>Inscripciones vencidas</h3>
            <br/>
            <table>
                <thead>
                    <th>Plantel</th><th>Especialidad</th><th>Nivel</th><th>Grado</th><th>Cliente</th>
                    <th>Estatus</th><th>Grupo</th><th>Lectivo</th><th>Fin Lectivo</th>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$r->nivel}}</td>
                        <td>{{$r->grado}}</td>
                        <td>{{$r->cliente_id}} {{$r->nombre}} {{$r->nombre2}} {{$r->ape_paterno}} {{$r->ape_materno}}</td>
                        <td>{{$r->st_cliente}}</td>
                        <td>{{$r->grupo}}</td>
                        <td>{{$r->lectivo}}</td><td>{{$r->fin}}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
