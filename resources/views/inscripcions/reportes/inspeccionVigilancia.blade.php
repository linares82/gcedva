...
@section('header')
	...
	<ol class="breadcrumb">
	    ...
	    <li class="active">Inspección Vigilancia</li>
	</ol>

    <div class="page-header">
        <h3><i class="glyphicon glyphicon-plus"></i> @yield('seguimientosAppTitle') / Inspección Vigilancia </h3>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::open(array('route' => 'inscripcions.inspeccionVigilanciaR', 'id'=>'frm_analitica')) !!}
