...
<div class="row">
    <div class="col-md-12">
        ...
        {!! Form::open(array('route' => 'inventarioLevantamientos.inicioLevantamientoListaC', 'id'=>'frmPlanteles')) !!}
        ...
        <div class="form-group col-md-6 @if($errors->has('incluir_segmentos_existe_estado')) has-error @endif" >
            <label for="incluir_segmentos_existe_estado-field">Incluir Segmentos Existe-Estado</label>
            {!! Form::select("incluir_segmentos_existe_estado", $sinSegmentos, 'SI', array("class" => "form-control select_seguridad", "id" => "existe_si-field")) !!}
            @if($errors->has("incluir_segmentos_existe_estado"))
            <span class="help-block">{{ $errors->first("incluir_segmentos_existe_estado") }}</span>
            @endif
        </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{route('inventarioLevantamientos.inicioLevantamientoCsv', 
                                array('plantel'=>$r->plantel_id,'fecha'=>$r->fecha, 
