...
@section('header')
    ...
    <ol class="breadcrumb">
        ...
        @if ( $query_params = Request::input('q') )
            ...
            <li class="active"><a href="{{ route('motivoBecas.index') }}">@yield('motivoBecasAppTitle')</a></li>
        ...
        @else
            <li class="active">@yield('motivoBecasAppTitle')</li>
        @endif
        -->
        <li class="active">@yield('motivoBecasAppTitle')</li>
    </ol>
    ...
    <div class="">
        <h3>
            <i class="glyphicon glyphicon-align-justify"></i> @yield('motivoBecasAppTitle')
            @permission('motivoBecas.create')
            <a class="btn btn-success pull-right" href="{{ route('motivoBecas.create') }}"><i class="glyphicon glyphicon-plus"></i> Crear</a>
            @endpermission
        </h3>
        ...
        <div class="panel panel-default">
            ...
            <div aria-labelledby="headingOne" role="tabpanel" class="panel-collapse collapse" id="collapseOne">
                <div class="panel-body">
                    <form class="MotivoBeca_search" id="search" action="{{ route('motivoBecas.index') }}" accept-charset="UTF-8" method="get">
        ...
        <div class="col-md-12">
            @if($motivoBecas->count())
                <table class="table table-condensed table-striped">
                    ...
                    <tbody>
                        @foreach($motivoBecas as $motivoBeca)
                            <tr>
                    ...
                    <td>{{$motivoBeca->usu_mod_id}}</td>
                                <td class="text-right">
                                    ...
                                    @endpermission
                                    @permission('motivoBecas.destroy')
                                    {!! Form::model($motivoBeca, array('route' => array('motivoBecas.destroy', $motivoBeca->id),'method' => 'delete', 'style' => 'display: inline;', 'onsubmit'=> "if(confirm('¿Borrar? ¿Esta seguro?')) { return true } else {return false };")) !!}
                ...
                {!! $motivoBecas->appends(Request::except('page'))->render() !!}
            @else
