  ...
  <body>
    ...
    <div class="datagrid">
        ...
        <table class="table table-condensed table-striped">
            <thead>
                <tr>
                  <th>Plantel</th><th>Especialidad</th><th>id</th><th>Cliente</th><!--<th>Becado</th>--><th>Caja</th><th>Cobrado Por</th><!--<th>Estatus</th>--><th>Fecha Pago</th><th>Fecha Creacion</th><th>Concepto</th><th>Monto Pago</th><th>Forma Pago</th><th>Beca</th>
                </tr> 
            </thead>
            <tbody>
                <?php 
                ...
                @@endif    
                    -->    
                <!--@@if($forma_pago<>$registro->forma_pago_id and !is_null($forma_pago))
                    <tr>
                        <td colspan="9"><strong>Total Forma de Pago  </strong></td><td style="text-align:right;"><strong>{{number_format($total_forma_pago,2)}}</strong></td><td></td><td></td>
                    </tr>
                    @php $total_forma_pago=0; @endphp
                @@endif
                  -->
                  @if($especialidad<>$registro->especialidad and !is_null($especialidad))
                  <tr>
                      <td colspan="9"><strong>Total Forma de Pago  </strong></td><td style="text-align:right;"><strong>{{number_format($total_especialidad,2)}}</strong></td><td></td><td></td>
                  </tr>
                  @php $total_especialidad=0; @endphp
                  @endif
                    ...
                    $total_especialidad=$total_especialidad+$registro->monto_pago;
                ...
                @endforeach
                    ...
                    <!--
                    <tr>
                      <td colspan="9"><strong>Total Concepto</strong></td><td style="text-align:right;"><strong>{{number_format($concepto_suma,2)}}</strong></td><td></td><td></td>
                    </tr>
                  -->
                    <tr>
                        <td><strong>Total Especalidad</strong></td><td colspan="8"><strong><strong></td><td style="text-align:right;"><strong>{{number_format($total_especialidad,2)}}</strong></td><td></td> <td></td>
                    </tr>
                    <tr>
                        <td><strong>Total</strong></td><td colspan="8"><strong><strong></td><td style="text-align:right;"><strong>{{number_format($suma_total,2)}}</strong></td><td></td><td></td>
                    </tr>
