...
@section('header')
    ...
    <div class="page-header">
        <h3><i class="glyphicon glyphicon-plus"></i>  / Concentrado Parciales </h3>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::open(array('route' => 'periodoEstudios.concentradoParcialesR', 'id'=>'frm_reporte')) !!}
                ...
                <div class="form-group col-md-6 @if($errors->has('periodos_estudio')) has-error @endif">
                    ...
                    {!! Form::select("periodos_estudio", $list['Grado'], null, array("class" => "form-control select_seguridad", "id" => "periodos_estudio-field")) !!}
