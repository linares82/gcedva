...
@section('header')
    ...
    <div class="page-header">
        <h3><i class="glyphicon glyphicon-plus"></i>  / Registro Grupos Ordinarios </h3>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::open(array('route' => 'periodoEstudios.grupoOrdinariosR', 'id'=>'frm_reporte')) !!}
                ...
                <div class="form-group col-md-6 @if($errors->has('estatus_f')) has-error @endif">
                    ...
                    {!! Form::select("estatus_f[]", $stEmpleados, null, array("class" => "form-control select_seguridad", "id" => "estatus_f-field", 'multiple'=>true)) !!}
