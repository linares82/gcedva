...
@section('header')
    ...
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-duplicate"></i> @yield('peticionMultipagosAppTitle') / Duplicar {{$peticionMultipago->id}}</h1>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::model($peticionMultipago, array('route' => array('peticionMultipagos.store'))) !!}
