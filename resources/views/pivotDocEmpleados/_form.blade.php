                <div class="form-group @if($errors->has('empleado_id')) has-error @endif">
                       ...
                       {!! Form::text("empleado_id", null, array("class" => "form-control input-sm", "id" => "empleado_id-field")) !!}
                    ...
                    <div class="form-group @if($errors->has('doc_empleado_id')) has-error @endif">
                       ...
                       {!! Form::text("doc_empleado_id", null, array("class" => "form-control input-sm", "id" => "doc_empleado_id-field")) !!}
