...
@section('header')
    ...
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-duplicate"></i> @yield('planCondicionFiltrosAppTitle') / Duplicar {{$planCondicionFiltro->id}}</h1>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::model($planCondicionFiltro, array('route' => array('planCondicionFiltros.store'))) !!}
