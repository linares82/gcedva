...
@section('header')
    ...
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-duplicate"></i> @yield('plantillaEmpresaCondsAppTitle') / Duplicar {{$plantillaEmpresaCond->id}}</h1>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::model($plantillaEmpresaCond, array('route' => array('plantillaEmpresaConds.store'))) !!}
