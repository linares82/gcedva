                <div class="form-group @if($errors->has('name')) has-error @endif">
                    ...
                    <div class="form-group @if($errors->has('tpo_examen_id')) has-error @endif">
                       <label for="tpo_examen_id-field">Tpo_examen_id</label>
                       {!! Form::text("tpo_examen_id", null, array("class" => "form-control input-sm", "id" => "tpo_examen_id-field")) !!}
