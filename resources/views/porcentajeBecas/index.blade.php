...
@section('header')
    ...
    <ol class="breadcrumb">
        ...
        @if ( $query_params = Request::input('q') )
            ...
            <li class="active"><a href="{{ route('porcentajeBecas.index') }}">@yield('porcentajeBecasAppTitle')</a></li>
        ...
        @else
            <li class="active">@yield('porcentajeBecasAppTitle')</li>
        @endif
        -->
        <li class="active">@yield('porcentajeBecasAppTitle')</li>
    </ol>
    ...
    <div class="">
        <h3>
            <i class="glyphicon glyphicon-align-justify"></i> @yield('porcentajeBecasAppTitle')
            @permission('porcentajeBecas.create')
            <a class="btn btn-success pull-right" href="{{ route('porcentajeBecas.create') }}"><i class="glyphicon glyphicon-plus"></i> Crear</a>
            @endpermission
        </h3>
        ...
        <div class="panel panel-default">
            ...
            <div aria-labelledby="headingOne" role="tabpanel" class="panel-collapse collapse" id="collapseOne">
                <div class="panel-body">
                    <form class="PorcentajeBeca_search" id="search" action="{{ route('porcentajeBecas.index') }}" accept-charset="UTF-8" method="get">
        ...
        <div class="col-md-12">
            @if($porcentajeBecas->count())
                <table class="table table-condensed table-striped">
                    ...
                    <tbody>
                        @foreach($porcentajeBecas as $porcentajeBeca)
                            <tr>
                    ...
                    <td>{{$porcentajeBeca->usu_mod_id}}</td>
                                <td class="text-right">
                                    ...
                                    @endpermission
                                    @permission('porcentajeBecas.destroy')
                                    {!! Form::model($porcentajeBeca, array('route' => array('porcentajeBecas.destroy', $porcentajeBeca->id),'method' => 'delete', 'style' => 'display: inline;', 'onsubmit'=> "if(confirm('¿Borrar? ¿Esta seguro?')) { return true } else {return false };")) !!}
                ...
                {!! $porcentajeBecas->appends(Request::except('page'))->render() !!}
            @else
