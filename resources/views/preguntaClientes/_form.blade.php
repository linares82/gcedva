                <div class="form-group col-md-4 @if($errors->has('pregunta_id')) has-error @endif">
                       ...
                       {!! Form::text("pregunta_id", null, array("class" => "form-control input-sm", "id" => "pregunta_id-field")) !!}
                    ...
                    <div class="form-group col-md-4 @if($errors->has('respuesta')) has-error @endif">
                       ...
                       {!! Form::text("respuesta", null, array("class" => "form-control input-sm", "id" => "respuesta-field")) !!}
