...
@section('header')
    ...
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-duplicate"></i> @yield('prospectoEtiquetasAppTitle') / Duplicar {{$prospectoEtiquetum->id}}</h1>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::model($prospectoEtiquetum, array('route' => array('prospectoEtiquetas.store'))) !!}
