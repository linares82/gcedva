    ...
    <div class="datagrid">
        ...
        <table border="0" width="100%">
            <td border="0" align="center">
                <h3>
                    Detalle KPI's del {{ $datos['fecha_f'] }} al {{ $datos['fecha_t'] }}
                </h3>
            </td>
        </table>
        <table border="1" width="100%">
            <thead>
                <tr>
                    ...
                    <th>Lead Creado</th>
                    <th>Prospecto</th>
                    <th>Prospecto Ceador</th>
                    <th>Prospecto Creado</th>
                    <th>Tarea</th>
                    <th>Tarea Creada</th>
                    <th>Tarea Estatus</th>
                    <th>Tarea Creador</th>
            ...
            <tbody>
                @foreach ($registros as $registro)
                    <tr>
                        <td>{{ $registro['lead_plantel'] }}</td>
                        <td>{{ $registro['lead_creador'] }}</td>
                        <td>{{ $registro['lead_id'] }}</td>
                        <td>{{ $registro['lead_st'] }}</td>
                        <td>{{ $registro['lead_created_at'] }}</td>
                        <td>{{ $registro['prospecto_id'] }}</td>
