    ...
    <div class="datagrid">
        ...
        <table>
            <thead>
                    ...
                    <th>F. Alta</th><th>Usuario</th><th>Estatus</th><th>Cantidad</th>
            </thead>
            <tbody>
        ...
        <table>
            <thead>
                    ...
                    <th>Teléfono</th><th>Mail</th><th>Plantel</th><th>Especialidad</th>
                    <th>Nivel</th><th>Medio</th><th>Usuario Alta</th><th>Estatus</th>
            </thead>
            <tbody>
            ...
            <tr>
                ...
                <td>{{ $registro->tel_fijo }}</td><td>{{ $registro->mail }}</td>
                <td>{{ $registro->plantel->razon }}</td><td>{{ $registro->especialidad->name }}</td>
                <td>{{ $registro->nivel->name }}</td>
                <td>{{ $registro->medio->name }}</td><td>{{ $registro->usu_alta->name }}</td>
