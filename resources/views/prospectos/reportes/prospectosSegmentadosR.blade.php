...
<body>
    ...
    <!--webdatarocks-->
    <h3>Prospectos Segmentados</h3>
    <div id="wdr-component"></div>

    <div>
        <table>
            <thead>
                <th>Plantel</th><th>Cliente Id</th><th>Estatus Actual</th><th>Estatus Historico</th>
                <th>Fecha Estatus</th><th>Ultima Actualizacion</th><th>Usuario</th>
            </thead>
            <tbody>
                @foreach($cambios as $cambio)
                <tr>
                    <td>{{$cambio->razon}}</td><td>{{$cambio->cliente}}</td><td>{{$cambio->estatus_actual}}</td>
                    <td>{{$cambio->estatus_historico}}</td><td>{{$cambio->fecha_estatus}}</td>
                    <td>{{$cambio->ultima_actualizacion}}</td><td>{{$cambio->usuario}}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
            ...
            report: {
                ...
                "slice": {
                    "rows": [{
                        ...
                        {
                            "uniqueName": "estatus_historico"
                        }
                    ],
                    "columns": [{
                            "uniqueName": "fecha_estatus.Year"
                        },
                        {
                            "uniqueName": "fecha_estatus.Month"
                        },
                        {
                            "uniqueName": "Measures"
                        }
                    ...
                    "expands": {
                        "rows": [{
                            "tuple": [
                                "razon.CELAYA BACHILLERATO, TÉCNICOS, IMA Y LIC. ADMVAS. 46-15"
                            ]
                        }]
                    }
                }
