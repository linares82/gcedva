...
@section('header')
    ...
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-duplicate"></i> @yield('registroHistoriaClientesAppTitle') / Duplicar {{$registroHistoriaCliente->id}}</h1>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::model($registroHistoriaCliente, array('route' => array('registroHistoriaClientes.store'))) !!}
