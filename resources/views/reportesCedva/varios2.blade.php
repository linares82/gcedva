...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::open(array('route' => 'reportesCedva.reportes2R', 'id'=>'frm_analitica')) !!}
...
-->
                <div class="form-group col-md-6 @if($errors->has('bnd_mensualidad')) has-error @endif">
                
                  <label for="html">Mensualidad
                <input type="radio" id="mensualidad" name="mensualidad" value="1">
                </label><br>
                
                  <label for="css">No Mensualidad
                <input type="radio" id="no_mensualidad" name="mensualidad" value="0">
                </label><br>
