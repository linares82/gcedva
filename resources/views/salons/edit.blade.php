...
@section('header')
	...
	<ol class="breadcrumb">
	    ...
	    <li><a href="{{ route('salons.show', $salon->id) }}">{{ $salon->id }}</a></li>
	    <li class="active">Editar</li>
	</ol>

    <div class="page-header">
        <h3><i class="glyphicon glyphicon-edit"></i> @yield('salonsAppTitle') / Editar {{$salon->id}}</h3>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::model($salon, array('route' => array('salons.update', $salon->id),'method' => 'post')) !!}
