...
@section('header')
    ...
    <ol class="breadcrumb">
        ...
        @if ( $query_params = Request::input('q') )
            ...
            <li class="active"><a href="{{ route('seccions.index') }}">@yield('seccionsAppTitle')</a></li>
    ...
    <div class="">
        <h3>
            ...
            @permission('seccions.create')
            <a class="btn btn-success pull-right" href="{{ route('seccions.create') }}"><i class="glyphicon glyphicon-plus"></i> Crear</a>
            @endpermission
        </h3>
        ...
        <div class="panel panel-default">
            ...
            <div aria-labelledby="headingOne" role="tabpanel" class="panel-collapse collapse" id="collapseOne">
                <div class="panel-body">
                    <form class="Seccion_search" id="search" action="{{ route('seccions.index') }}" accept-charset="UTF-8" method="get">
    ...
    <div class="row">
        <div class="col-md-12">
            @if($seccions->count())
                ...
                {!! $seccions->appends(Request::except('page'))->render() !!}
            @else
