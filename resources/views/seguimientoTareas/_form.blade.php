                <div class="form-group col-md-4 @if($errors->has('asignacion_tarea_id')) has-error @endif">
                       ...
                       {!! Form::text("asignacion_tarea_id", null, array("class" => "form-control input-sm", "id" => "asignacion_tarea_id-field")) !!}
                    ...
                    <div class="form-group col-md-4 @if($errors->has('estatus_id')) has-error @endif">
                       ...
                       {!! Form::text("estatus_id", null, array("class" => "form-control input-sm", "id" => "estatus_id-field")) !!}
