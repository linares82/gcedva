...
@section('header')
	...
	<ol class="breadcrumb">
	    ...
	    <li><a href="{{ route('seguimientos.show', $seguimiento->id) }}">{{ $seguimiento->id }}</a></li>
	    <li class="active">Editar</li>
	</ol>

    <div class="page-header">
        <h3><i class="glyphicon glyphicon-edit"></i> @yield('seguimientosAppTitle') / Editar {{$seguimiento->id}}</h3>
    </div>
@endsection
