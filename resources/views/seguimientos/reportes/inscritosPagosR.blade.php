<html>
  ...
  <body>
      <h3>Pagos por Plantel del {{$data['fecha_f']}} al {{$data['fecha_t']}}</h3>
    <div class="datagrid">
        ...
        <table class="table table-condensed table-striped">
            ...
            <tbody>
                ...
                @foreach($registros_pagados as $registro)
                    ...
                    <tr>
                        <td><strong>Suma Asesor</strong></td><td colspan="5"><strong>{{$i}}<strong></td><td colspan="2"><strong>{{number_format($total_monto)}}</strong></td>
                    </tr>
                    <?php 
                    $j=$i+$j;
                    $i=0;
                    ...
                    $suma_total=$suma_total+$registro->pago;
                    ?>
                @endforeach
                    <?php 
                    $j=$i+$j;
