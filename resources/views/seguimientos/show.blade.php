...
<div class="row">
    <div class="col-md-12">
        <table class="table table-condensed table-striped">
            ...
            <tbody>
                <td>{{ $seguimiento->cliente->plantel->razon }}</td>
                <td>{{ $seguimiento->cliente->especialidad->name  }}</td>
                <td>{{ $seguimiento->cliente->nivel->name }}</td>
                <td>{{ $seguimiento->cliente->grado->name }}</td>
            ...
            <div class="box box-default">
                <div class="box-body">
                    ...
                    <div class="form-group col-md-12 @if($errors->has('cve_cliente')) has-error @endif">
                        ...
                        <label for="cve_cliente-field">SMS(Max. 160 catacteres)</label>
                        <div id="contador"></div>
