...
@section('header')
    ...
    <div class="page-header">
        <h3><i class="glyphicon glyphicon-plus"></i> @yield('sepFundamentoLegalServicioSocialsAppTitle') / Crear </h3>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::open(array('route' => 'sepFundamentoLegalServicioSocials.store')) !!}
