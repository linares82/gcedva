...
@section('header')
    ...
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-duplicate"></i> @yield('sepFundamentoLegalServicioSocialsAppTitle') / Duplicar {{$sepFundamentoLegalServicioSocial->id}}</h1>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::model($sepFundamentoLegalServicioSocial, array('route' => array('sepFundamentoLegalServicioSocials.store'))) !!}
