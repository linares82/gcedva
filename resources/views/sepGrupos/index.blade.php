...
@section('header')
    ...
    <ol class="breadcrumb">
        ...
        @if ( $query_params = Request::input('q') )
            ...
            <li class="active"><a href="{{ route('sepGrupos.index') }}">@yield('sepGruposAppTitle')</a></li>
        ...
        @else
            <li class="active">@yield('sepGruposAppTitle')</li>
        @endif
        -->
        <li class="active">@yield('sepGruposAppTitle')</li>
    </ol>
    ...
    <div class="">
        <h3>
            <i class="glyphicon glyphicon-align-justify"></i> @yield('sepGruposAppTitle')
            @permission('sepGrupos.create')
            <a class="btn btn-success pull-right" href="{{ route('sepGrupos.create') }}"><i class="glyphicon glyphicon-plus"></i> Crear</a>
            @endpermission
        </h3>
        ...
        <div class="panel panel-default">
            ...
            <div aria-labelledby="headingOne" role="tabpanel" class="panel-collapse collapse" id="collapseOne">
                <div class="panel-body">
                    <form class="SepGrupo_search" id="search" action="{{ route('sepGrupos.index') }}" accept-charset="UTF-8" method="get">
    ...
    <div class="row">
        <div class="col-md-12">
            @if($sepGrupos->count())
                        ...
                        @foreach($sepGrupos as $sepGrupo)
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    @endpermission
                                    @permission('sepGrupos.destroy')
                                    {!! Form::model($sepGrupo, array('route' => array('sepGrupos.destroy', $sepGrupo->id),'method' => 'delete', 'style' => 'display: inline;', 'onsubmit'=> "if(confirm('¿Borrar? ¿Esta seguro?')) { return true } else {return false };")) !!}
                ...
                {!! $sepGrupos->appends(Request::except('page'))->render() !!}
            @else
