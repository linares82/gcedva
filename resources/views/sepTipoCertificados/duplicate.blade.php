...
@section('header')
    ...
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-duplicate"></i> @yield('sepTipoCertificadosAppTitle') / Duplicar {{$sepTipoCertificado->id}}</h1>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::model($sepTipoCertificado, array('route' => array('sepTipoCertificados.store'))) !!}
