...
@section('header')
    ...
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-duplicate"></i> @yield('tareasEmpresasAppTitle') / Duplicar {{$tareasEmpresa->id}}</h1>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::model($tareasEmpresa, array('route' => array('tareasEmpresas.store'))) !!}
