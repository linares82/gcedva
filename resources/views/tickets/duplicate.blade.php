...
@section('header')
    ...
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-duplicate"></i> @yield('ticketsAppTitle') / Duplicar {{$ticket->id}}</h1>
    </div>
@endsection
...
@include('tickets._form')
                ...
                <div class="well well-sm">
                    ...
                    <a class="btn btn-link pull-right" href="{{ route('tickets.index') }}"><i class="glyphicon glyphicon-backward"></i> Regresar</a>
                </div>
            {!! Form::close() !!}
