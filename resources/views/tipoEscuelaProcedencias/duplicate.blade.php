...
@section('header')
    ...
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-duplicate"></i> @yield('tipoEscuelaProcedenciasAppTitle') / Duplicar {{$tipoEscuelaProcedencium->id}}</h1>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::model($tipoEscuelaProcedencium, array('route' => array('tipoEscuelaProcedencias.store'))) !!}
