...
@section('header')
    ...
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-duplicate"></i> @yield('titulacionDocumentacionsAppTitle') / Duplicar {{$titulacionDocumentacion->id}}</h1>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::model($titulacionDocumentacion, array('route' => array('titulacionDocumentacions.store'))) !!}
