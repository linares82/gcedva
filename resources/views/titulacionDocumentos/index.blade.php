                        ...
                        @foreach($titulacionDocumentos as $titulacionDocumento)
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    {!! Form::model($titulacionDocumento, array('route' => array('titulacionDocumentos.destroy', $titulacionDocumento->id),'method' => 'delete', 'style' => 'display: inline;', 'onsubmit'=> "if(confirm('¿Borrar? ¿Esta seguro?')) { return true } else {return false };")) !!}
