<div class="nav-tabs-custom">
    <ul class="nav nav-tabs">
        <li class="active">
            <a data-toggle="tab" href="#tab1">Titulacion</a>
        </li>
        <li class="">
            <a data-toggle="tab" href="#tab2">Procedencia</a>
        </li>
    </ul>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group @if ($errors->has('fec_inicio')) has-error @endif">
                                ...
                                {!! Form::hidden('cliente_id', isset($cliente) ? $cliente : null, [
                                    'class' => 'form-control',
                                    'id' => 'cliente_id-field',
                                ]) !!}
                            ...
                            <div class="form-group @if ($errors->has('opcion_titulacion_id')) has-error @endif">
                                ...
                                {!! Form::select('opcion_titulacion_id', $opciones_titulacion, null, [
                                    'class' => 'form-control select_seguridad',
                                    'id' => 'opcion_titulacion_id-field',
                                ]) !!}
                            ...
                            <div class="form-group @if ($errors->has('titulacion_documento_id')) has-error @endif">
                                ...
                                {!! Form::select('titulacion_documento_id', $documentos, null, [
                                    'class' => 'form-control select_seguridad',
                                    'id' => 'titulacion_documento_id-field',
                                    'style' => 'width:100%',
                                ]) !!}
                            ...
                            @php
                                if (isset($titulacion)) {
                                    $vinculacion = \App\Vinculacion::where('cliente_id', $titulacion->cliente_id)
                                        ->orderBy('id', 'desc')
                                        ->first();
                                }
                            ...
                            <div class="form-group col-md-12 @if ($errors->has('bnd_doc_vinc_revisados')) has-error @endif">
                                @if (isset($vinculacion))
                                    <a class="btn btn-xs btn-info"
                                        href="{{ route('vinculacions.edit', $vinculacion->id) }}"
                                        target="_bank">Vinculacion Docs.</a>
                                @endif
                                <label for="bnd_doc_vinc_revisados-field">Doc. Vinc. Revisados</label>

                                {!! Form::checkbox('bnd_doc_vinc_revisados', 1, null, [
                                    'id' => 'bnd_doc_vinc_revisados-field',
                                    'class' => 'minimal',
                                ]) !!}
                            ...
                            <div class="form-group col-md-12 @if ($errors->has('bnd_revision_director')) has-error @endif">
                                ...
                                @permission('titulacions.revision_director')
                                    {!! Form::checkbox('bnd_revision_director', 1, null, [
                                        'id' => 'bnd_revision_director-field',
                                        'class' => 'minimal',
                                    ]) !!}
                                    @endif
                                    ...
                                    <tbody>
                                        @foreach ($titulacion->titulacionDocumentacions as $doc)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ asset('imagenes/titulacion/' . $titulacion->id . '/' . $doc->archivo) }}"
                                                        target="_blank">Ver</a>
                                                </td>
                                                <td>
                                                    <a class="btn btn-xs btn-danger"
                                                        href="{{ route('titulacionDocumentacions.destroy', ['id' => $doc->id]) }}">Eliminar</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                    ...
                    <div class="box">
                        <div class="box-body">
                            <div class="form-group col-md-4 @if ($errors->has('fecha_expedicion')) has-error @endif">
                                ...
                                {!! Form::text('fecha_expedicion', null, ['class' => 'form-control fecha', 'id' => 'fecha_expedicion-field']) !!}
                                @if ($errors->has('fecha_expedicion'))
                                    <span class="help-block">{{ $errors->first('fecha_expedicion') }}</span>
                                @endif
                            </div>
                            <div class="form-group col-md-4 @if ($errors->has('fecha_examen_profesional')) has-error @endif">
                                <label for="fecha_examen_profesional-field">Fecha Examen Profesional</label>
                                {!! Form::text('fecha_examen_profesional', null, [
                                    'class' => 'form-control fecha',
                                    'id' => 'fecha_examen_profesional-field',
                                ]) !!}
                                @if ($errors->has('fecha_examen_profesional'))
                                    <span class="help-block">{{ $errors->first('fecha_examen_profesional') }}</span>
                                @endif
                            </div>
                            <div class="form-group col-md-4 @if ($errors->has('fecha_excencion_examen_profesional')) has-error @endif">
                                <label for="fecha_excencion_examen_profesional-field">Fecha Excencion Examen
                                    Profesional</label>
                                {!! Form::text('fecha_excencion_examen_profesional', null, [
                                    'class' => 'form-control fecha',
                                    'id' => 'fecha_excencion_examen_profesional-field',
                                ]) !!}
                                @if ($errors->has('fecha_excencion_examen_profesional'))
                                    <span
                                        class="help-block">{{ $errors->first('fecha_excencion_examen_profesional') }}</span>
                                @endif
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="box">
                            <div class="box-body">
                                ...
                                @permission('titulacions.CRUDIngresos')
                                    <button class="btn btn-xs btn-success" id="btn-guardar-pago"
                                        data-titulacion="{{ $titulacion->id }}">Crear</button>
                                    <button class="btn btn-xs btn-warning" id="btn-update-pago"
                                    ...
                                    <tbody>
                                        @foreach ($titulacion->titulacionPagos as $pago)
                                            <tr>
                                                ...
                                                <td>
                                                    @permission('titulacions.CRUDIngresos')
                                                        <button class="btn btn-xs btn-warning btn-editar-pago"
                                                    ...
                                                    @permission('titulacions.EliminarIngreso')
                                                        <a class="btn btn-xs btn-danger" id="btn-eliminar-pago"
                                        ...
                                        <tr>
                                            <td></td>
                                            <td>{{ $suma_pagos = $titulacion->titulacionPagos->where('titulacion_id', $titulacion->id)->sum('monto') }}
                                            </td>
                                            <td></td>
                                            <td></td>
                                        </tr>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="box">
                                <div class="box-body">
                                    <div
                                        class="form-group col-md-6 @if ($errors->has('intento')) has-error @endif">
                                    ...
                                    <div
                                        class="form-group col-md-6 @if ($errors->has('fec_examen')) has-error @endif">
                                    ...
                                    <div
                                        class="form-group col-md-6 @if ($errors->has('bnd_titulado')) has-error @endif">
                                    ...
                                    <div class="form-group col-md-6">
                                        @permission('titulacions.CRUDintentos')
                                            <button class="btn btn-xs btn-success" id="btn-agregar-intento">Agregar
                                                Intento</button>
                                            <button class="btn btn-xs btn-warning" id="btn-update-intento"
                                                style="display:none;">Guardar
                                                Intento</button>
                                            <button class="btn btn-xs btn-danger" id="btn-cancelar-intento">Cancelar
                                                Intento</button>
                                        @endpermission
                                    </div>
                                </div>
    ...
    <div id="tab2" class="tab-pane">
        <fieldset>
            <div class="form-group col-md-4 @if ($errors->has('institucion_procedencia')) has-error @endif">
                ...
                {!! Form::text('institucion_procedencia', null, [
                    'class' => 'form-control',
                    'id' => 'institucion_procedencia-field',
                ]) !!}
            ...
            <div class="form-group col-md-4 @if ($errors->has('sep_t_estudio_antecedente_id')) has-error @endif">
                ...
                {!! Form::select('sep_t_estudio_antecedente_id', $sepTipoEstudioAntecedente, null, [
                    'class' => 'form-control select_seguridad',
                    'id' => 'sep_t_estudio_antecedente_id-field',
                ]) !!}
            ...
            <div class="form-group col-md-4 @if ($errors->has('estado_procedencia_id')) has-error @endif">
                ...
                {!! Form::select('estado_procedencia_id', $estados, null, [
                    'class' => 'form-control select_seguridad',
                    'id' => 'estado_procedencia_id-field',
                ]) !!}
            ...
            <div class="form-group col-md-4 @if ($errors->has('fecha_terminacion')) has-error @endif">
                ...
                {!! Form::text('fecha_terminacion', null, [
                    'class' => 'form-control fecha',
                    'id' => 'fecha_terminacion-field',
                ]) !!}
            ...
            <div class="form-group col-md-4 @if ($errors->has('numero_cedula')) has-error @endif">
                ...
                {!! Form::text('numero_cedula', null, [
                    'class' => 'form-control',
                    'id' => 'numero_cedula-field',
                ]) !!}
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on("click", "#btn_archivo", function(e) {
                ...
                data.append('titulacion_documento_id', $('#titulacion_documento_id-field option:selected')
                    .val());
                @if (isset($titulacion))
