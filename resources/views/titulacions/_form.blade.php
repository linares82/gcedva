               ...
               <div class="col-md-4">
                   ...
                   <div class="form-group col-md-12 @if ($errors->has('bnd_doc_vinc_revisados')) has-error @endif">
                       @if (isset($vinculacion))
                           <a class="btn btn-xs btn-info" href="{{ route('vinculacions.edit', $vinculacion->id) }}"
            ...
            <div class="box">
                <div class="box-body">
                   ...
                   <div class="form-group col-md-4 @if ($errors->has('fecha_examen_profesional')) has-error @endif">
                       ...
                       {!! Form::text('fecha_examen_profesional', null, ['class' => 'form-control fecha', 'id' => 'fecha_examen_profesional-field']) !!}
                   ...
                   <div class="form-group col-md-4 @if ($errors->has('fecha_excencion_examen_profesional')) has-error @endif">
                       <label for="fecha_excencion_examen_profesional-field">Fecha Excencion Examen Profesional</label>
                       {!! Form::text('fecha_excencion_examen_profesional', null, ['class' => 'form-control fecha', 'id' => 'fecha_excencion_examen_profesional-field']) !!}
                       @if ($errors->has('fecha_excencion_examen_profesional'))
                           <span class="help-block">{{ $errors->first('fecha_excencion_examen_profesional') }}</span>
                       @endif
                   </div>
                </div>
            </div>
                                       ...
                                       <td>
                                           @permission('titulacions.CRUDIngresos')
                                               <button class="btn btn-xs btn-warning btn-editar-pago"
                                                   ...
                                                   data-fecha="{{ $pago->fecha }}" data-monto="{{ $pago->monto }}"
