        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h4 class="box-title">
                    ...
                    @if($avance<=75) <div class="bg-red">Sigue esforzandote.
            </div>
            @elseif($avance>75 and $avance<=90) <div class="bg-yellow">Estas cada dia más cerca.
        </div>
        @elseif($avance>90)
    ...
    <div class="info-box">
        ...
        <div class="info-box-content">
            ...
            <a href="{{ route('clientes.index').'?q[s]=&q[clientes.nombre_cont]=&q[st_seguimiento_id_cont]=2&q[clientes.plantel_id_cont]='.
                                                        ...
                                                        '&commit=Buscar' }}" class="small-box-footer">Ver <i class="fa fa-arrow-circle-right"></i></a>
        </div>
    ...
    <script type="text/javascript">
        ...
        function drawVisualization() {
            ...
            var options = {
                ...
                vAxis: {
                    title: 'Cantidad de Clientes por Estatus'
                },
                hAxis: {
                    title: 'Empleado'
                },
        ...
        function drawgrfDir1() {
            ...
            var optionsA = {
                title: '',
                vAxis: {
                    title: 'Cantidad Clientes Por Estatus'
                },
                hAxis: {
                    title: 'Estatus'
                },
    ...
    <script type="text/javascript">
        ...
        function drawChart_maestroIndicador{{$plantel->id}}() {
            $.ajax({
                ...
                beforeSend: function() {
                    $("#loading{{ $plantel->id }}").show();
                },
                complete: function() {
                    $("#loading{{ $plantel->id }}").hide();
                },
                success: function(data) {
