...
<head>
    <meta charset="UTF-8">
    <title><?php echo e(isset($page_title) ? $page_title : "CrmScool"); ?></title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
	<link rel="shortcut icon" href="<?php echo e(asset('favicon.ico')); ?>" />
    
    <!-- Bootstrap 3.3.2 -->
    <link href="<?php echo e(asset('/bower_components/AdminLTE/bootstrap/css/bootstrap.css')); ?>" rel="stylesheet" type="text/css" />
    <!-- Font Awesome Icons -->
    ...
    <link rel="stylesheet" href="<?php echo e(asset('/bower_components/AdminLTE/plugins/datatables/dataTables.bootstrap_flc.css')); ?>">
    ...
    <!--Multiselect-->
    <link rel="stylesheet" href="<?php echo e(asset('/lou-multi-select/css/multi-select.css')); ?>">
	  <!--Zebra datepicker-->
	  <link rel="stylesheet" href=" <?php echo e(asset('/zebra_datepicker/public/css/bootstrap.css')); ?> ">
    <!-- Select2 -->
...
<div class="wrapper">
    ...
    <!-- Sidebar -->
    <?php echo $__env->make('plantillas/sidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<!--Multiselect-->
<script src="<?php echo e(asset ('/lou-multi-select/js/jquery.multi-select.js')); ?>"></script>
<!--Datepicker zebra-->
<script src="<?php echo e(asset ('/zebra_datepicker/public/javascript/zebra_datepicker.js')); ?>"></script>
<!-- Select2 -->
<script src="<?php echo e(asset ('/bower_components/AdminLTE/plugins/select2/select2.min.js')); ?>"></script>
