...
class Sms {
     ...
     * @return boolean         
     */
    public function validatePhoneNumbers(array $phones, $throw = false, $rule = 'AUTO,MX,mobile'){
    ...
    public function validatePhoneNumber($phone, $throw = false, $rule = 'AUTO,MX,mobile'){
